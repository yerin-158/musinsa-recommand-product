...
1. **브랜드 추가 및 관리**: 새로운 브랜드를 추가하고, 상태를 변경하며, 브랜드 정보를 조회하는 기능을 구현하였습니다.
2. **상품 추가 및 관리**: 특정 브랜드에 상품을 추가하고, 수정 및 삭제하며, 브랜드의 모든 상품을 조회하는 기능을 구현하였습니다.
3. **카테고리 관리**: 모든 카테고리를 조회하는 기능을 구현하였습니다.
4. **추천 제품 조회**: 특정 조건에 따라 추천 제품 목록을 조회하는 기능을 구현하였습니다.
5. **가격 통계 관리**: 브랜드 및 카테고리별로 가장 비싼 상품과 가장 저렴한 상품을 관리하는 기능을 구현하였습니다.
